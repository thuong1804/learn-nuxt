<template>
  ...
  <Popular />
  <div class=" flex w-full items-center justify-center pt-[64px]">
    <div class=" w-full max-w-[1240px] md:max-w-[78rem]l outline-1 outline-offset-[-0.50px] outline-black/10" />
  </div>
  <TopSelling />
  <div class=" flex w-full items-center justify-center pt-[64px]">
    <div class=" w-full max-w-[1240px] md:max-w-[78rem]l outline-1 outline-offset-[-0.50px] outline-black/10" />
